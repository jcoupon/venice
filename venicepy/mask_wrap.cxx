...
#define SWIGTYPE_p_Mask swig_types[0]
...
/*-----------------------------------------------
              @(target):= _venicepy.so
  ------------------------------------------------*/
#define SWIG_init    init_venicepy

#define SWIG_name    "_venicepy"
...
SWIGINTERN void Mask__check_point_array(Mask *self,double *ra,int nra,double *dec,int ndec,int *out,int nout){
    if (nra != ndec) {
...
SWIGINTERN int Mask__random_cat_array(Mask *self,double bounds[4],int inout,double *out_ra,int nra,double *out_dec,int ndec){
...
SWIGINTERN PyObject *_wrap_new_Mask(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_Mask" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  result = (Mask *)new Mask(arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Mask, SWIG_POINTER_NEW |  0 );
...
SWIGINTERN PyObject *_wrap_delete_Mask(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Mask, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Mask" "', argument " "1"" of type '" "Mask *""'"); 
  }
  arg1 = reinterpret_cast< Mask * >(argp1);
  delete arg1;
...
SWIGINTERN PyObject *_wrap_Mask__check_point(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Mask *arg1 = (Mask *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:Mask__check_point",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Mask, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Mask__check_point" "', argument " "1"" of type '" "Mask *""'"); 
  }
  arg1 = reinterpret_cast< Mask * >(argp1);
  {
  ...
  {
    Mask__check_point_array(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
...
SWIGINTERN PyObject *_wrap_Mask__random_cat(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Mask *arg1 = (Mask *) 0 ;
  double *arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:Mask__random_cat",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Mask, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Mask__random_cat" "', argument " "1"" of type '" "Mask *""'"); 
  }
  arg1 = reinterpret_cast< Mask * >(argp1);
  {
    npy_intp size[1] = {
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Mask__random_cat" "', argument " "3"" of type '" "int""'");
  } 
  ...
  result = (int)Mask__random_cat_array(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
...
SWIGINTERN PyObject *Mask_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  SWIG_TypeNewClientData(SWIGTYPE_p_Mask, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

static PyMethodDef SwigMethods[] = {
	 { (char *)"new_Mask", _wrap_new_Mask, METH_VARARGS, (char *)"new_Mask(mask_file) -> Mask"},
	 { (char *)"delete_Mask", _wrap_delete_Mask, METH_VARARGS, (char *)"delete_Mask(self)"},
	 { (char *)"Mask__check_point", _wrap_Mask__check_point, METH_VARARGS, (char *)"Mask__check_point(self, ra, dec, out)"},
	 { (char *)"Mask__random_cat", _wrap_Mask__random_cat, METH_VARARGS, (char *)"Mask__random_cat(self, bounds, inout, out_ra, out_dec) -> int"},
